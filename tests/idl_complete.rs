...
fn test_schema_loader() {
    ...
    assert_eq!(
        Ok(Document { parts: vec![
            NamespacePart::Enum(Enum { name: "UserState".to_string(), values: vec![
                "ACTIVE".to_string(),
                "INACTIVE".to_string(),
                "BANNED".to_string()
            ]}),
            NamespacePart::Struct(Struct { name: "UserRequest".to_string(), fields: vec![
                Field { name: "email".to_string(), type_: Type::Named("Email".to_string()), optional: false, options: vec![] }
            ]}),
            NamespacePart::Struct(Struct { name: "Name".to_string(), fields: vec![
            ...
            NamespacePart::Fieldset(Fieldset { name: "NameUpdate".to_string(), struct_name: "Name".to_string(), fields: vec![
            ...
            NamespacePart::Struct(Struct { name: "User".to_string(), fields: vec![
            ...
            NamespacePart::Fieldset(Fieldset { name: "UserRead".to_string(), struct_name: "User".to_string(), fields: vec![
            ...
            NamespacePart::Fieldset(Fieldset { name: "UserWrite".to_string(), struct_name: "User".to_string(), fields: vec![
                FieldsetField { name: "id".to_string(), optional: false },
            ...
            NamespacePart::Struct(Struct { name: "UserListRequest".to_string(), fields: vec![
            ...
            NamespacePart::Struct(Struct { name: "UserList".to_string(), fields: vec![
            ...
            NamespacePart::Enum(Enum { name: "GetError".to_string(), values: vec![
                "PermissionDenied".to_string(),
                "DoesNotExist".to_string()
            ]}),
            NamespacePart::Enum(Enum { name: "ListError".to_string(), values: vec![
                "PermissionDenied".to_string()
            ]}),
            ...
            NamespacePart::Service(Service { name: "example".to_string(), endpoints: vec![
                ServiceEndpoint {
                    name: "get_version".to_string(),
                    in_: true,
                    out: true
